...
September22 resumed: phone aa1 fallback, boot5d40be8b-a600-4c14-b504-7dec6b31b327, AppArmorN; authentication fixes persist (helper4755/socketmasked/passwordmode2). Docker restarted. Wi-Fi PM candidate committed/pushed a50-halium9726a20; mock callback tests pass. Fresh a50-kbuild-aa11-wifi-sleep compiling with volumea50-ksrc-aa11-wifi-sleep/outputout-aa11-wifi-sleep, all aa10 flags plus --wifi-sleep-fix. No aa11 flash yet. Kernel logger886MiB archived privately /userdata/a50-session20-release/kmsg-capture-before-20260922.log; capture-kmsg.py now bounds active logs to8MiB x4, root0600, retains existing filter and per-record fdatasync. Serviceactive and filecreated; filter/rotation testpasses. TWRP read-only audit SHA8535a9d9193243412fcefc0e6f1ba585d60e1533e65069867444a49d0287e51f, header1/page2048/kernel_addr0x10008000/ramdisk_addr0x11000000/tags0x10000100. Recovery untouched. Official unified recovery build545 downloaded to taskwork (15309945bytes SHA054faa7a0cbc8792bdbdb91fb1ed9eafcfbacf9f35b4171cc9d4d98ac958da56); not built/flashed. Current tools main5112934e3db4af048beb191750b6f35b151f7a7f supports unified recovery, oldhalium11branch41435c7 does not contain the same integration. Existing CI branch pin is not a current unified recovery path; conventional build integration remains pending.
